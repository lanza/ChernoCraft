...
Texture::Texture(std::string file) { texture = load(file); }
...
void Texture::enable() { glBindTexture(GL_TEXTURE_2D, texture); }

void Texture::disable() { glBindTexture(GL_TEXTURE_2D, 0); }
